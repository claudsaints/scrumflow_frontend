...
@Component({
  selector: 'app-project-card-pop-up',
  imports: [
    DialogModule,
    ButtonModule,
    CommonModule,
  ...
  templateUrl: './project-card-pop-up.component.html',
  styleUrl: './project-card-pop-up.component.css',
})
export class ProjectCardPopUpComponent {
